...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,toolbar:[
            'bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat | selectall cleardoc | justifyleft justifycenter justifyright justifyjustify | link unlink | emotion  horizontal'
        ]
