$(function() {
  ...
  customDialog.show = function(el, title, cb, showcb) {
    customDialog.title = title;
    cb ? (customDialog.cb = cb) : (customDialog.cb = emptyfn);
    showcb ? (customDialog.showcb = showcb) : (customDialog.showcb = emptyfn);
  ...
  customDialog.dialog.on('shown.bs.modal', function() {
    customDialog.showcb();
  });
